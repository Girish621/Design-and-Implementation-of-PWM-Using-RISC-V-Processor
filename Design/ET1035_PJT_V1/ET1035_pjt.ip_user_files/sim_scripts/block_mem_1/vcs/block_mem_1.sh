...
#
# Script generated by Vivado on Sat Aug 09 08:43:00 +0530 2025
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : block_mem_1.sh
...
#
# Usage        : block_mem_1.sh
#                block_mem_1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                block_mem_1.sh [-reset_run]
#                block_mem_1.sh [-reset_log]
#                block_mem_1.sh [-help]
#
...
#                script (type 'block_mem_1.sh -help' for more information).
#
...
# script info
echo -e "block_mem_1.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./block_mem_1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.block_mem_1 xil_defaultlib.glbl -o block_mem_1_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./block_mem_1_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key block_mem_1_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc block_mem_1_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./block_mem_1.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: block_mem_1.sh [-help]\n\
Usage: block_mem_1.sh [-step]\n\
Usage: block_mem_1.sh [-lib_map_path]\n\
Usage: block_mem_1.sh [-reset_run]\n\
Usage: block_mem_1.sh [-reset_log]\n\
Usage: block_mem_1.sh [-keep_index]\n\
Usage: block_mem_1.sh [-noclean_files]\n\n\
